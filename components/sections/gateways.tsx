...
export function Gateways() {
  ...
  return (
    <section
      id="gateways"
      className="border-border bg-cloud border-y py-16 sm:py-24"
    >
      <Container>
        <Reveal>
            ...
            return (
              ...
              >
                <div className="relative aspect-[16/10] overflow-hidden">
                  ...
                  />
                  <div className="from-ink/75 absolute inset-0 bg-gradient-to-t to-transparent" />
                  <span className="bg-navy absolute bottom-3 left-4 inline-flex size-10 items-center justify-center rounded-lg text-white">
                    <Icon className="size-5" />
                  </span>
                </div>
                <div className="p-5">
                  <h3 className="text-h3 font-heading text-navy font-semibold">
