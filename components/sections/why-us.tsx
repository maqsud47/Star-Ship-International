          ...
          {WHY.map((w) => {
            ...
            return (
              <div key={w.key} className="flex gap-4">
                <span className="bg-signal/10 text-signal mt-0.5 inline-flex size-10 shrink-0 items-center justify-center rounded-lg">
                  <Icon className="size-5" />
                </span>
                <div>
                  <h3 className="font-heading text-navy text-base font-semibold">
