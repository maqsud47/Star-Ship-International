          ...
          {SERVICES.map((s) => {
            ...
            return (
              <Link key={s.slug} href={`/services/${s.slug}`} className="group h-full">
                <Card className="ssi-lift h-full">
                  <CardHeader>
                    <span className="bg-signal/10 text-signal mb-2 inline-flex size-11 items-center justify-center rounded-lg transition-colors duration-300 group-hover:bg-signal group-hover:text-white">
                  ...
                  <CardContent>
                    <span className="text-signal inline-flex items-center gap-1 text-sm font-medium">
                      {t("cta.learnMore")}
