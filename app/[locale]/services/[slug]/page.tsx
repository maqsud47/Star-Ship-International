      ...
      <section className="py-16 sm:py-24">
        <Container className="grid gap-12 lg:grid-cols-[1.4fr_1fr] lg:gap-16">
          <div>
            <Link
              href="/services"
              className="text-signal inline-flex items-center gap-1.5 text-sm font-medium hover:underline"
            >
            ...
            <h2 className="text-h3 text-navy font-heading mt-10 font-semibold">
          ...
          {/* Gateways aside */}
          <aside className="border-border bg-cloud h-fit rounded-2xl border p-7">
              ...
              {GATEWAYS.map((g) => {
                ...
                return (
                  <li key={g.key} className="flex items-start gap-3">
                    <span className="bg-navy inline-flex size-9 shrink-0 items-center justify-center rounded-lg text-white">
