          ...
          <div className="mt-10 flex flex-col gap-6">
            {FLEET.map((v, i) => {
              ...
              return (
                <Reveal
                  key={v.key}
                  className="ring-border shadow-card ssi-lift group grid overflow-hidden rounded-2xl bg-white ring-1 lg:grid-cols-2"
                >
                  <div
                    className={cn(
                  ...
                  >
                    <span className="bg-signal/10 text-signal inline-flex size-11 items-center justify-center rounded-lg">
                      <Icon className="size-5" />
                    </span>
                    <h3 className="font-heading text-navy mt-4 text-xl font-bold">
                      {t(`roadTransportPage.fleet.${v.key}.name`)}
                    </h3>
                    <div className="mt-2 flex items-center gap-2">
                      <span className="bg-navy/5 text-navy inline-flex rounded-full px-3 py-1 text-xs font-semibold">
